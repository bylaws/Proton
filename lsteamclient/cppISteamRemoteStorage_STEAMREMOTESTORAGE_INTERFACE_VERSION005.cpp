...
NTSTATUS wow64_ISteamRemoteStorage_STEAMREMOTESTORAGE_INTERFACE_VERSION005_PublishFile( void *args )
{
    ...
    params->_ret = iface->PublishFile( (const char *)params->pchFile, (const char *)params->pchPreviewFile, params->nConsumerAppId, (const char *)params->pchTitle, (const char *)params->pchDescription, params->eVisibility, &u_pTags );
...
NTSTATUS wow64_ISteamRemoteStorage_STEAMREMOTESTORAGE_INTERFACE_VERSION005_PublishWorkshopFile( void *args )
{
    ...
    u_SteamParamStringArray_t u_pTags = *w_pTags;
    u_pTags.m_ppStrings = (const char **)wow64_convert_ptr_array( w_pTags->m_ppStrings, w_pTags->m_nNumStrings );
    params->_ret = iface->PublishWorkshopFile( u_pchFile, u_pchPreviewFile, params->nConsumerAppId, (const char *)params->pchTitle, (const char *)params->pchDescription, &u_pTags );
    free( u_pTags.m_ppStrings );
    steamclient_free_path( u_pchFile );
    steamclient_free_path( u_pchPreviewFile );
    return 0;
