...
NTSTATUS ISteamUtils_SteamUtils010_CheckFileSignature( void *args )
{
    ...
    struct u_ISteamUtils_SteamUtils010 *iface = (struct u_ISteamUtils_SteamUtils010 *)params->linux_side;
    char *u_szFileName = steamclient_dos_to_unix_path( (const char *)params->szFileName, 0 );
...
NTSTATUS wow64_ISteamUtils_SteamUtils010_ShowGamepadTextInput( void *args )
{
    ...
    struct u_ISteamUtils_SteamUtils010 *iface = (struct u_ISteamUtils_SteamUtils010 *)params->linux_side;
    params->_ret = iface->ShowGamepadTextInput( params->eInputMode, params->eLineInputMode, (const char *)params->pchDescription, params->unCharMax, (const char *)params->pchExistingText );
    return 0;
}
...
NTSTATUS wow64_ISteamUtils_SteamUtils010_GetEnteredGamepadTextInput( void *args )
{
    ...
    struct u_ISteamUtils_SteamUtils010 *iface = (struct u_ISteamUtils_SteamUtils010 *)params->linux_side;
    params->_ret = iface->GetEnteredGamepadTextInput( (char *)params->pchText, params->cchText );
    return 0;
}
...
NTSTATUS wow64_ISteamUtils_SteamUtils010_FilterText( void *args )
{
    ...
    struct u_ISteamUtils_SteamUtils010 *iface = (struct u_ISteamUtils_SteamUtils010 *)params->linux_side;
    params->_ret = iface->FilterText( params->eContext, params->sourceSteamID, (const char *)params->pchInputMessage, (char *)params->pchOutFilteredText, params->nByteSizeOutFilteredText );
    return 0;
}
