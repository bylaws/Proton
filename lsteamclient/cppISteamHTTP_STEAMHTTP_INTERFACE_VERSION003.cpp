...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_CreateHTTPRequest( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->CreateHTTPRequest( params->eHTTPRequestMethod, (const char *)params->pchAbsoluteURL );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_SetHTTPRequestHeaderValue( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SetHTTPRequestHeaderValue( params->hRequest, (const char *)params->pchHeaderName, (const char *)params->pchHeaderValue );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_SetHTTPRequestGetOrPostParameter( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SetHTTPRequestGetOrPostParameter( params->hRequest, (const char *)params->pchParamName, (const char *)params->pchParamValue );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_SendHTTPRequest( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SendHTTPRequest( params->hRequest, (uint64_t *)params->pCallHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_SendHTTPRequestAndStreamResponse( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SendHTTPRequestAndStreamResponse( params->hRequest, (uint64_t *)params->pCallHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_GetHTTPResponseHeaderSize( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetHTTPResponseHeaderSize( params->hRequest, (const char *)params->pchHeaderName, (uint32_t *)params->unResponseHeaderSize );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_GetHTTPResponseHeaderValue( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetHTTPResponseHeaderValue( params->hRequest, (const char *)params->pchHeaderName, (uint8_t *)params->pHeaderValueBuffer, params->unBufferSize );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_GetHTTPResponseBodySize( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetHTTPResponseBodySize( params->hRequest, (uint32_t *)params->unBodySize );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_GetHTTPResponseBodyData( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetHTTPResponseBodyData( params->hRequest, (uint8_t *)params->pBodyDataBuffer, params->unBufferSize );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_GetHTTPStreamingResponseBodyData( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetHTTPStreamingResponseBodyData( params->hRequest, params->cOffset, (uint8_t *)params->pBodyDataBuffer, params->unBufferSize );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_GetHTTPDownloadProgressPct( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetHTTPDownloadProgressPct( params->hRequest, (float *)params->pflPercentOut );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_SetHTTPRequestRawPostBody( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SetHTTPRequestRawPostBody( params->hRequest, (const char *)params->pchContentType, (uint8_t *)params->pubBody, params->unBodyLen );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_SetCookie( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SetCookie( params->hCookieContainer, (const char *)params->pchHost, (const char *)params->pchUrl, (const char *)params->pchCookie );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_SetHTTPRequestUserAgentInfo( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SetHTTPRequestUserAgentInfo( params->hRequest, (const char *)params->pchUserAgentInfo );
    return 0;
}
...
NTSTATUS wow64_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003_GetHTTPRequestWasTimedOut( void *args )
{
    ...
    struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *iface = (struct u_ISteamHTTP_STEAMHTTP_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetHTTPRequestWasTimedOut( params->hRequest, (int8_t *)params->pbWasTimedOut );
    return 0;
}
