...
NTSTATUS wow64_ISteamNetworking_SteamNetworking003_SendP2PPacket( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking003 *iface = (struct u_ISteamNetworking_SteamNetworking003 *)params->linux_side;
    params->_ret = iface->SendP2PPacket( params->steamIDRemote, (const void *)params->pubData, params->cubData, params->eP2PSendType );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworking_SteamNetworking003_IsP2PPacketAvailable( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking003 *iface = (struct u_ISteamNetworking_SteamNetworking003 *)params->linux_side;
    params->_ret = iface->IsP2PPacketAvailable( (uint32_t *)params->pcubMsgSize );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworking_SteamNetworking003_ReadP2PPacket( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking003 *iface = (struct u_ISteamNetworking_SteamNetworking003 *)params->linux_side;
    params->_ret = iface->ReadP2PPacket( (void *)params->pubDest, params->cubDest, (uint32_t *)params->pcubMsgSize, (CSteamID *)params->psteamIDRemote );
    return 0;
}
