...
NTSTATUS wow64_ISteamNetworking_SteamNetworking004_SendP2PPacket( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking004 *iface = (struct u_ISteamNetworking_SteamNetworking004 *)params->linux_side;
    params->_ret = iface->SendP2PPacket( params->steamIDRemote, (const void *)params->pubData, params->cubData, params->eP2PSendType, params->nVirtualPort );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworking_SteamNetworking004_IsP2PPacketAvailable( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking004 *iface = (struct u_ISteamNetworking_SteamNetworking004 *)params->linux_side;
    params->_ret = iface->IsP2PPacketAvailable( (uint32_t *)params->pcubMsgSize, params->nVirtualPort );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworking_SteamNetworking004_ReadP2PPacket( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking004 *iface = (struct u_ISteamNetworking_SteamNetworking004 *)params->linux_side;
    params->_ret = iface->ReadP2PPacket( (void *)params->pubDest, params->cubDest, (uint32_t *)params->pcubMsgSize, (CSteamID *)params->psteamIDRemote, params->nVirtualPort );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworking_SteamNetworking004_GetSocketInfo( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking004 *iface = (struct u_ISteamNetworking_SteamNetworking004 *)params->linux_side;
    params->_ret = iface->GetSocketInfo( params->hSocket, (CSteamID *)params->pSteamIDRemote, (int32_t *)params->peSocketStatus, (uint32_t *)params->punIPRemote, (uint16_t *)params->punPortRemote );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworking_SteamNetworking004_GetListenSocketInfo( void *args )
{
    ...
    struct u_ISteamNetworking_SteamNetworking004 *iface = (struct u_ISteamNetworking_SteamNetworking004 *)params->linux_side;
    params->_ret = iface->GetListenSocketInfo( params->hListenSocket, (uint32_t *)params->pnIP, (uint16_t *)params->pnPort );
    return 0;
}
