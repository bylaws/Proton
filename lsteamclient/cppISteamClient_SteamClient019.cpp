...
NTSTATUS wow64_ISteamClient_SteamClient019_CreateLocalUser( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->CreateLocalUser( (int32_t *)params->phSteamPipe, params->eAccountType );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamUser( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamUser( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamGameServer( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamGameServer( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamFriends( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamFriends( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamUtils( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamUtils( params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamMatchmaking( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamMatchmaking( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamMatchmakingServers( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamMatchmakingServers( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamGenericInterface( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamGenericInterface( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamUserStats( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamUserStats( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamGameServerStats( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamGameServerStats( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamApps( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamApps( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamNetworking( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamNetworking( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamRemoteStorage( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamRemoteStorage( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamScreenshots( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamScreenshots( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamGameSearch( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamGameSearch( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamHTTP( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamHTTP( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_DEPRECATED_GetISteamUnifiedMessages( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->DEPRECATED_GetISteamUnifiedMessages( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamController( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamController( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamUGC( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamUGC( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamAppList( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamAppList( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamMusic( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamMusic( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamMusicRemote( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamMusicRemote( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamHTMLSurface( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamHTMLSurface( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_DEPRECATED_Set_SteamAPI_CPostAPIResultInProcess( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    void (*U_CDECL u__a)(void) = manual_convert_DEPRECATED_Set_SteamAPI_CPostAPIResultInProcess__a( (void (*W_CDECL )(void))params->_a );
    iface->DEPRECATED_Set_SteamAPI_CPostAPIResultInProcess( u__a );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_DEPRECATED_Remove_SteamAPI_CPostAPIResultInProcess( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    void (*U_CDECL u__a)(void) = manual_convert_DEPRECATED_Remove_SteamAPI_CPostAPIResultInProcess__a( (void (*W_CDECL )(void))params->_a );
    iface->DEPRECATED_Remove_SteamAPI_CPostAPIResultInProcess( u__a );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_Set_SteamAPI_CCheckCallbackRegisteredInProcess( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    uint32_t (*U_CDECL u_func)(int32_t) = manual_convert_Set_SteamAPI_CCheckCallbackRegisteredInProcess_func( (uint32_t (*W_CDECL )(int32_t))params->func );
    iface->Set_SteamAPI_CCheckCallbackRegisteredInProcess( u_func );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamInventory( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamInventory( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamVideo( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamVideo( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamParentalSettings( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamParentalSettings( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamInput( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamInput( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamParties( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamParties( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient019_GetISteamRemotePlay( void *args )
{
    ...
    struct u_ISteamClient_SteamClient019 *iface = (struct u_ISteamClient_SteamClient019 *)params->linux_side;
    params->_ret = iface->GetISteamRemotePlay( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
