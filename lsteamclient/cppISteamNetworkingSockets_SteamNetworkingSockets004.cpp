...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets004_CreateListenSocketIP( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *)params->linux_side;
    params->_ret = iface->CreateListenSocketIP( (const SteamNetworkingIPAddr *)params->localAddress );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets004_ConnectByIPAddress( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *)params->linux_side;
    params->_ret = iface->ConnectByIPAddress( (const SteamNetworkingIPAddr *)params->address );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets004_ConnectP2P( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *)params->linux_side;
    params->_ret = iface->ConnectP2P( (const SteamNetworkingIdentity_144 *)params->identityRemote, params->nVirtualPort );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets004_SendMessageToConnection( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *)params->linux_side;
    params->_ret = iface->SendMessageToConnection( params->hConn, (const void *)params->pData, params->cbData, params->nSendFlags );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets004_ConnectToHostedDedicatedServer( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets004 *)params->linux_side;
    params->_ret = iface->ConnectToHostedDedicatedServer( (const SteamNetworkingIdentity_144 *)params->identityTarget, params->nVirtualPort );
    return 0;
}
