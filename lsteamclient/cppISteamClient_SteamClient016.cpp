...
NTSTATUS wow64_ISteamClient_SteamClient016_GetISteamUnifiedMessages( void *args )
{
    ...
    struct u_ISteamClient_SteamClient016 *iface = (struct u_ISteamClient_SteamClient016 *)params->linux_side;
    params->_ret = iface->GetISteamUnifiedMessages( params->hSteamuser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient016_Set_SteamAPI_CPostAPIResultInProcess( void *args )
{
    ...
    struct u_ISteamClient_SteamClient016 *iface = (struct u_ISteamClient_SteamClient016 *)params->linux_side;
    void (*U_CDECL u_func)(uint64_t, void *, uint32_t, int32_t) = manual_convert_Set_SteamAPI_CPostAPIResultInProcess_func( (void (*W_CDECL )(uint64_t, void *, uint32_t, int32_t))params->func );
    iface->Set_SteamAPI_CPostAPIResultInProcess( u_func );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient016_Remove_SteamAPI_CPostAPIResultInProcess( void *args )
{
    ...
    struct u_ISteamClient_SteamClient016 *iface = (struct u_ISteamClient_SteamClient016 *)params->linux_side;
    void (*U_CDECL u_func)(uint64_t, void *, uint32_t, int32_t) = manual_convert_Remove_SteamAPI_CPostAPIResultInProcess_func( (void (*W_CDECL )(uint64_t, void *, uint32_t, int32_t))params->func );
    iface->Remove_SteamAPI_CPostAPIResultInProcess( u_func );
    return 0;
}
