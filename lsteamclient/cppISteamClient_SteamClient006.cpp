...
NTSTATUS wow64_ISteamClient_SteamClient006_CreateGlobalUser( void *args )
{
    ...
    struct u_ISteamClient_SteamClient006 *iface = (struct u_ISteamClient_SteamClient006 *)params->linux_side;
    params->_ret = iface->CreateGlobalUser( (int32_t *)params->phSteamPipe );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient006_GetISteamBilling( void *args )
{
    ...
    struct u_ISteamClient_SteamClient006 *iface = (struct u_ISteamClient_SteamClient006 *)params->linux_side;
    params->_ret = iface->GetISteamBilling( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
