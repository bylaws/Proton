...
NTSTATUS wow64_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003_WriteScreenshot( void *args )
{
    ...
    struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *iface = (struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->WriteScreenshot( (void *)params->pubRGB, params->cubRGB, params->nWidth, params->nHeight );
    return 0;
}
...
NTSTATUS ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003_AddScreenshotToLibrary( void *args )
{
    ...
    struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *iface = (struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *)params->linux_side;
    char *u_pchFilename = steamclient_dos_to_unix_path( (const char *)params->pchFilename, 0 );
    char *u_pchThumbnailFilename = steamclient_dos_to_unix_path( (const char *)params->pchThumbnailFilename, 0 );
...
NTSTATUS wow64_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003_SetLocation( void *args )
{
    ...
    struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *iface = (struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->SetLocation( params->hScreenshot, (const char *)params->pchLocation );
    return 0;
}
...
NTSTATUS ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003_AddVRScreenshotToLibrary( void *args )
{
    ...
    struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *iface = (struct u_ISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION003 *)params->linux_side;
    char *u_pchFilename = steamclient_dos_to_unix_path( (const char *)params->pchFilename, 0 );
    char *u_pchVRFilename = steamclient_dos_to_unix_path( (const char *)params->pchVRFilename, 0 );
