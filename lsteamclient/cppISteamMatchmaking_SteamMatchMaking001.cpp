...
NTSTATUS wow64_ISteamMatchmaking_SteamMatchMaking001_GetFavoriteGame( void *args )
{
    ...
    struct u_ISteamMatchmaking_SteamMatchMaking001 *iface = (struct u_ISteamMatchmaking_SteamMatchMaking001 *)params->linux_side;
    params->_ret = iface->GetFavoriteGame( params->iGame, (uint32_t *)params->pnAppID, (uint32_t *)params->pnIP, (uint16_t *)params->pnConnPort, (uint32_t *)params->punFlags, (uint32_t *)params->pRTime32LastPlayedOnServer );
    return 0;
}
...
NTSTATUS wow64_ISteamMatchmaking_SteamMatchMaking001_GetFavoriteGame2( void *args )
{
    ...
    struct u_ISteamMatchmaking_SteamMatchMaking001 *iface = (struct u_ISteamMatchmaking_SteamMatchMaking001 *)params->linux_side;
    params->_ret = iface->GetFavoriteGame2( params->iGame, (uint32_t *)params->pnAppID, (uint32_t *)params->pnIP, (uint16_t *)params->pnConnPort, (uint16_t *)params->pnQueryPort, (uint32_t *)params->punFlags, (uint32_t *)params->pRTime32LastPlayedOnServer );
    return 0;
}
...
NTSTATUS wow64_ISteamMatchmaking_SteamMatchMaking001_RequestLobbyList( void *args )
{
    ...
    struct u_ISteamMatchmaking_SteamMatchMaking001 *iface = (struct u_ISteamMatchmaking_SteamMatchMaking001 *)params->linux_side;
    iface->RequestLobbyList( params->ulGameID, (MatchMakingKeyValuePair_t *)params->pFilters, params->nFilters );
    return 0;
}
...
NTSTATUS wow64_ISteamMatchmaking_SteamMatchMaking001_SetLobbyMemberData( void *args )
{
    ...
    struct u_ISteamMatchmaking_SteamMatchMaking001 *iface = (struct u_ISteamMatchmaking_SteamMatchMaking001 *)params->linux_side;
    params->_ret = iface->SetLobbyMemberData( params->steamIDLobby, (const char *)params->pchKey, (const char *)params->pchValue );
    return 0;
}
