...
NTSTATUS wow64_ISteamUGC_STEAMUGC_INTERFACE_VERSION003_GetItemInstallInfo( void *args )
{
    ...
    struct u_ISteamUGC_STEAMUGC_INTERFACE_VERSION003 *iface = (struct u_ISteamUGC_STEAMUGC_INTERFACE_VERSION003 *)params->linux_side;
    params->_ret = iface->GetItemInstallInfo( params->nPublishedFileID, (uint64_t *)params->punSizeOnDisk, (char *)params->pchFolder, params->cchFolderSize, (int8_t *)params->pbLegacyItem );
    steamclient_unix_path_to_dos_path( params->_ret, (const char *)params->pchFolder, (char *)params->pchFolder, params->cchFolderSize, 0 );
    return 0;
}
