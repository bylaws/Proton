...
extern void queue_vtable_callback( struct w_steam_iface *w_iface, enum callback_type type, uint64_t arg0, uint64_t arg1 );
...
extern const struct callback_def *callback_data( bool w64 );
extern unsigned int callback_data_size( bool w64 );
...
void *alloc_callback_wtou( int id, void *callback, int *callback_len, bool w64 );
void convert_callback_utow( int id, void *u_callback, int u_callback_len, void *w_callback, int w_callback_len, bool w64 );
...
extern NTSTATUS steamclient_bufcache_get( void * );
extern NTSTATUS steamclient_bufcache_put( void * );
...
extern const char **wow64_steamclient_dos_to_unix_path_array( uint32_t src_array );
