...
NTSTATUS wow64_ISteamMatchmaking_SteamMatchMaking005_AddRequestLobbyListFilter( void *args )
{
    ...
    struct u_ISteamMatchmaking_SteamMatchMaking005 *iface = (struct u_ISteamMatchmaking_SteamMatchMaking005 *)params->linux_side;
    iface->AddRequestLobbyListFilter( (const char *)params->pchKeyToMatch, (const char *)params->pchValueToMatch );
    return 0;
}
...
NTSTATUS wow64_ISteamMatchmaking_SteamMatchMaking005_AddRequestLobbyListNumericalFilter( void *args )
{
    ...
    struct u_ISteamMatchmaking_SteamMatchMaking005 *iface = (struct u_ISteamMatchmaking_SteamMatchMaking005 *)params->linux_side;
    iface->AddRequestLobbyListNumericalFilter( (const char *)params->pchKeyToMatch, params->nValueToMatch, params->nComparisonType );
    return 0;
}
