...
NTSTATUS wow64_ISteamParties_SteamParties002_GetBeaconDetails( void *args )
{
    ...
    struct u_ISteamParties_SteamParties002 *iface = (struct u_ISteamParties_SteamParties002 *)params->linux_side;
    u_SteamPartyBeaconLocation_t u_pLocation = *(w32_SteamPartyBeaconLocation_t *)params->pLocation;
    params->_ret = iface->GetBeaconDetails( params->ulBeaconID, (CSteamID *)params->pSteamIDBeaconOwner, &u_pLocation, (char *)params->pchMetadata, params->cchMetadata );
    *(w32_SteamPartyBeaconLocation_t *)params->pLocation = u_pLocation;
    return 0;
}
...
NTSTATUS wow64_ISteamParties_SteamParties002_GetNumAvailableBeaconLocations( void *args )
{
    ...
    struct u_ISteamParties_SteamParties002 *iface = (struct u_ISteamParties_SteamParties002 *)params->linux_side;
    params->_ret = iface->GetNumAvailableBeaconLocations( (uint32_t *)params->puNumLocations );
    return 0;
}
...
NTSTATUS wow64_ISteamParties_SteamParties002_GetAvailableBeaconLocations( void *args )
{
    ...
    struct u_ISteamParties_SteamParties002 *iface = (struct u_ISteamParties_SteamParties002 *)params->linux_side;
    u_SteamPartyBeaconLocation_t u_pLocationList = *(w32_SteamPartyBeaconLocation_t *)params->pLocationList;
    params->_ret = iface->GetAvailableBeaconLocations( &u_pLocationList, params->uMaxNumLocations );
    *(w32_SteamPartyBeaconLocation_t *)params->pLocationList = u_pLocationList;
    return 0;
}
...
NTSTATUS wow64_ISteamParties_SteamParties002_CreateBeacon( void *args )
{
    ...
    struct u_ISteamParties_SteamParties002 *iface = (struct u_ISteamParties_SteamParties002 *)params->linux_side;
    u_SteamPartyBeaconLocation_t u_pBeaconLocation = *(w32_SteamPartyBeaconLocation_t *)params->pBeaconLocation;
    params->_ret = iface->CreateBeacon( params->unOpenSlots, &u_pBeaconLocation, (const char *)params->pchConnectString, (const char *)params->pchMetadata );
    *(w32_SteamPartyBeaconLocation_t *)params->pBeaconLocation = u_pBeaconLocation;
    return 0;
}
...
NTSTATUS wow64_ISteamParties_SteamParties002_GetBeaconLocationData( void *args )
{
    ...
    struct u_ISteamParties_SteamParties002 *iface = (struct u_ISteamParties_SteamParties002 *)params->linux_side;
    u_SteamPartyBeaconLocation_t u_BeaconLocation = params->BeaconLocation;
    params->_ret = iface->GetBeaconLocationData( u_BeaconLocation, params->eData, (char *)params->pchDataStringOut, params->cchDataStringOut );
    return 0;
}
