...
NTSTATUS ISteamInput_SteamInput006_SetInputActionManifestFilePath( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    char *u_pchInputActionManifestAbsolutePath = steamclient_dos_to_unix_path( (const char *)params->pchInputActionManifestAbsolutePath, 0 );
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetConnectedControllers( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetConnectedControllers( (uint64_t *)params->handlesOut );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetActionSetHandle( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetActionSetHandle( (const char *)params->pszActionSetName );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetActiveActionSetLayers( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetActiveActionSetLayers( params->inputHandle, (uint64_t *)params->handlesOut );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetDigitalActionHandle( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetDigitalActionHandle( (const char *)params->pszActionName );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetDigitalActionData( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    *(InputDigitalActionData_t *)params->_ret = iface->GetDigitalActionData( params->inputHandle, params->digitalActionHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetDigitalActionOrigins( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetDigitalActionOrigins( params->inputHandle, params->actionSetHandle, params->digitalActionHandle, (uint32_t *)params->originsOut );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetAnalogActionHandle( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetAnalogActionHandle( (const char *)params->pszActionName );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetAnalogActionData( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    *(InputAnalogActionData_t *)params->_ret = iface->GetAnalogActionData( params->inputHandle, params->analogActionHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetAnalogActionOrigins( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetAnalogActionOrigins( params->inputHandle, params->actionSetHandle, params->analogActionHandle, (uint32_t *)params->originsOut );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetMotionData( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    *(InputMotionData_t *)params->_ret = iface->GetMotionData( params->inputHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_GetDeviceBindingRevision( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    params->_ret = iface->GetDeviceBindingRevision( params->inputHandle, (int32_t *)params->pMajor, (int32_t *)params->pMinor );
    return 0;
}
...
NTSTATUS wow64_ISteamInput_SteamInput006_SetDualSenseTriggerEffect( void *args )
{
    ...
    struct u_ISteamInput_SteamInput006 *iface = (struct u_ISteamInput_SteamInput006 *)params->linux_side;
    iface->SetDualSenseTriggerEffect( params->inputHandle, (const ScePadTriggerEffectParam *)params->pParam );
    return 0;
}
