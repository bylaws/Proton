...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddSessionAttributeInt( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddSessionAttributeInt( params->ulSessionID, (const char *)params->pstrName, params->nData );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddSessionAttributeString( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddSessionAttributeString( params->ulSessionID, (const char *)params->pstrName, (const char *)params->pstrData );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddSessionAttributeFloat( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddSessionAttributeFloat( params->ulSessionID, (const char *)params->pstrName, params->fData );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddNewRow( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddNewRow( (uint64_t *)params->pulRowID, params->ulSessionID, (const char *)params->pstrTableName );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddRowAttributeInt( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddRowAttributeInt( params->ulRowID, (const char *)params->pstrName, params->nData );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddRowAtributeString( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddRowAtributeString( params->ulRowID, (const char *)params->pstrName, (const char *)params->pstrData );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddRowAttributeFloat( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddRowAttributeFloat( params->ulRowID, (const char *)params->pstrName, params->fData );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddSessionAttributeInt64( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddSessionAttributeInt64( params->ulSessionID, (const char *)params->pstrName, params->llData );
    return 0;
}
...
NTSTATUS wow64_ISteamGameStats_SteamGameStats001_AddRowAttributeInt64( void *args )
{
    ...
    struct u_ISteamGameStats_SteamGameStats001 *iface = (struct u_ISteamGameStats_SteamGameStats001 *)params->linux_side;
    params->_ret = iface->AddRowAttributeInt64( params->ulRowID, (const char *)params->pstrName, params->llData );
    return 0;
}
