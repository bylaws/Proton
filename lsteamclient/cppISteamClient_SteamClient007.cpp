...
NTSTATUS wow64_ISteamClient_SteamClient007_CreateLocalUser( void *args )
{
    ...
    struct u_ISteamClient_SteamClient007 *iface = (struct u_ISteamClient_SteamClient007 *)params->linux_side;
    params->_ret = iface->CreateLocalUser( (int32_t *)params->phSteamPipe );
    return 0;
}
...
NTSTATUS wow64_ISteamClient_SteamClient007_GetISteamContentServer( void *args )
{
    ...
    struct u_ISteamClient_SteamClient007 *iface = (struct u_ISteamClient_SteamClient007 *)params->linux_side;
    params->_ret = iface->GetISteamContentServer( params->hSteamUser, params->hSteamPipe, (const char *)params->pchVersion );
    return 0;
}
