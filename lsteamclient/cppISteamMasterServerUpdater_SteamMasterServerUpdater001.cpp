...
NTSTATUS wow64_ISteamMasterServerUpdater_SteamMasterServerUpdater001_SetBasicServerData( void *args )
{
    ...
    struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *iface = (struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *)params->linux_side;
    iface->SetBasicServerData( params->nProtocolVersion, params->bDedicatedServer, (const char *)params->pRegionName, (const char *)params->pProductName, params->nMaxReportedClients, params->bPasswordProtected, (const char *)params->pGameDescription );
    return 0;
}
...
NTSTATUS wow64_ISteamMasterServerUpdater_SteamMasterServerUpdater001_AddMasterServer( void *args )
{
    ...
    struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *iface = (struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *)params->linux_side;
    params->_ret = iface->AddMasterServer( (const char *)params->pServerAddress );
    return 0;
}
...
NTSTATUS wow64_ISteamMasterServerUpdater_SteamMasterServerUpdater001_RemoveMasterServer( void *args )
{
    ...
    struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *iface = (struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *)params->linux_side;
    params->_ret = iface->RemoveMasterServer( (const char *)params->pServerAddress );
    return 0;
}
...
NTSTATUS wow64_ISteamMasterServerUpdater_SteamMasterServerUpdater001_GetMasterServerAddress( void *args )
{
    ...
    struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *iface = (struct u_ISteamMasterServerUpdater_SteamMasterServerUpdater001 *)params->linux_side;
    params->_ret = iface->GetMasterServerAddress( params->iServer, (char *)params->pOut, params->outBufferSize );
    return 0;
}
