...
NTSTATUS wow64_ISteamUser_SteamUser004_GetSteamGameConnectToken( void *args )
{
    ...
    struct u_ISteamUser_SteamUser004 *iface = (struct u_ISteamUser_SteamUser004 *)params->linux_side;
    params->_ret = iface->GetSteamGameConnectToken( (void *)params->pBlob, params->cbMaxBlob );
    return 0;
}
...
NTSTATUS wow64_ISteamUser_SteamUser004_InitiateGameConnection( void *args )
{
    ...
    struct u_ISteamUser_SteamUser004 *iface = (struct u_ISteamUser_SteamUser004 *)params->linux_side;
    params->_ret = iface->InitiateGameConnection( (void *)params->pBlob, params->cbMaxBlob, params->steamID, params->nGameAppID, params->unIPServer, params->usPortServer, params->bSecure );
    return 0;
}
