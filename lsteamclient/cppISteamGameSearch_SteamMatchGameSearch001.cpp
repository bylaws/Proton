...
NTSTATUS wow64_ISteamGameSearch_SteamMatchGameSearch001_AddGameSearchParams( void *args )
{
    ...
    struct u_ISteamGameSearch_SteamMatchGameSearch001 *iface = (struct u_ISteamGameSearch_SteamMatchGameSearch001 *)params->linux_side;
    params->_ret = iface->AddGameSearchParams( (const char *)params->pchKeyToFind, (const char *)params->pchValuesToFind );
    return 0;
}
...
NTSTATUS wow64_ISteamGameSearch_SteamMatchGameSearch001_RetrieveConnectionDetails( void *args )
{
    ...
    struct u_ISteamGameSearch_SteamMatchGameSearch001 *iface = (struct u_ISteamGameSearch_SteamMatchGameSearch001 *)params->linux_side;
    params->_ret = iface->RetrieveConnectionDetails( params->steamIDHost, (char *)params->pchConnectionDetails, params->cubConnectionDetails );
    return 0;
}
...
NTSTATUS wow64_ISteamGameSearch_SteamMatchGameSearch001_SetGameHostParams( void *args )
{
    ...
    struct u_ISteamGameSearch_SteamMatchGameSearch001 *iface = (struct u_ISteamGameSearch_SteamMatchGameSearch001 *)params->linux_side;
    params->_ret = iface->SetGameHostParams( (const char *)params->pchKey, (const char *)params->pchValue );
    return 0;
}
...
NTSTATUS wow64_ISteamGameSearch_SteamMatchGameSearch001_SetConnectionDetails( void *args )
{
    ...
    struct u_ISteamGameSearch_SteamMatchGameSearch001 *iface = (struct u_ISteamGameSearch_SteamMatchGameSearch001 *)params->linux_side;
    params->_ret = iface->SetConnectionDetails( (const char *)params->pchConnectionDetails, params->cubConnectionDetails );
    return 0;
}
