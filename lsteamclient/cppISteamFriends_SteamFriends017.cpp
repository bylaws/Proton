...
NTSTATUS wow64_ISteamFriends_SteamFriends017_GetFriendsGroupMembersList( void *args )
{
    ...
    struct u_ISteamFriends_SteamFriends017 *iface = (struct u_ISteamFriends_SteamFriends017 *)params->linux_side;
    iface->GetFriendsGroupMembersList( params->friendsGroupID, (CSteamID *)params->pOutSteamIDMembers, params->nMembersCount );
    return 0;
}
...
NTSTATUS wow64_ISteamFriends_SteamFriends017_RegisterProtocolInOverlayBrowser( void *args )
{
    ...
    struct u_ISteamFriends_SteamFriends017 *iface = (struct u_ISteamFriends_SteamFriends017 *)params->linux_side;
    params->_ret = iface->RegisterProtocolInOverlayBrowser( (const char *)params->pchProtocol );
    return 0;
}
...
NTSTATUS wow64_ISteamFriends_SteamFriends017_ActivateGameOverlayInviteDialogConnectString( void *args )
{
    ...
    struct u_ISteamFriends_SteamFriends017 *iface = (struct u_ISteamFriends_SteamFriends017 *)params->linux_side;
    iface->ActivateGameOverlayInviteDialogConnectString( (const char *)params->pchConnectString );
    return 0;
}
