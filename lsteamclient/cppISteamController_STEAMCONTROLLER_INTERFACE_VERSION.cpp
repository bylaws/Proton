...
NTSTATUS ISteamController_STEAMCONTROLLER_INTERFACE_VERSION_Init( void *args )
{
    ...
    char *u_pchAbsolutePathToControllerConfigVDF = steamclient_dos_to_unix_path( (const char *)params->pchAbsolutePathToControllerConfigVDF, 0 );
...
NTSTATUS wow64_ISteamController_STEAMCONTROLLER_INTERFACE_VERSION_GetControllerState( void *args )
{
    ...
    struct u_ISteamController_STEAMCONTROLLER_INTERFACE_VERSION *iface = (struct u_ISteamController_STEAMCONTROLLER_INTERFACE_VERSION *)params->linux_side;
    params->_ret = iface->GetControllerState( params->unControllerIndex, (SteamControllerState001_t *)params->pState );
    return 0;
}
...
NTSTATUS wow64_ISteamController_STEAMCONTROLLER_INTERFACE_VERSION_SetOverrideMode( void *args )
{
    ...
    struct u_ISteamController_STEAMCONTROLLER_INTERFACE_VERSION *iface = (struct u_ISteamController_STEAMCONTROLLER_INTERFACE_VERSION *)params->linux_side;
    iface->SetOverrideMode( (const char *)params->pchMode );
    return 0;
}
