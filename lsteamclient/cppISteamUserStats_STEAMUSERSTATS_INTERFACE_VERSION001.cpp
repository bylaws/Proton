...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_GetStatType( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->GetStatType( params->nGameID, (const char *)params->pchName );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_GetStat( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->GetStat( params->nGameID, (const char *)params->pchName, (int32_t *)params->pData );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_GetStat_2( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->GetStat( params->nGameID, (const char *)params->pchName, (float *)params->pData );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_SetStat( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->SetStat( params->nGameID, (const char *)params->pchName, params->nData );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_SetStat_2( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->SetStat( params->nGameID, (const char *)params->pchName, params->fData );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_UpdateAvgRateStat( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->UpdateAvgRateStat( params->nGameID, (const char *)params->pchName, params->flCountThisSession, params->dSessionLength );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_GetAchievement( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->GetAchievement( params->nGameID, (const char *)params->pchName, (int8_t *)params->pbAchieved );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_GetGroupAchievement( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->GetGroupAchievement( params->nGameID, (const char *)params->pchName, (int8_t *)params->pbAchieved );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_SetAchievement( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->SetAchievement( params->nGameID, (const char *)params->pchName );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_SetGroupAchievement( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->SetGroupAchievement( params->nGameID, (const char *)params->pchName );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_ClearAchievement( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->ClearAchievement( params->nGameID, (const char *)params->pchName );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_ClearGroupAchievement( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->ClearGroupAchievement( params->nGameID, (const char *)params->pchName );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_GetAchievementIcon( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->GetAchievementIcon( params->nGameID, (const char *)params->pchName );
    return 0;
}
...
NTSTATUS wow64_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001_GetAchievementDisplayAttribute( void *args )
{
    ...
    struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *iface = (struct u_ISteamUserStats_STEAMUSERSTATS_INTERFACE_VERSION001 *)params->linux_side;
    params->_ret = iface->GetAchievementDisplayAttribute( params->nGameID, (const char *)params->pchName, (const char *)params->pchKey );
    params->_ret_size = params->_ret ? (strlen(params->_ret) + 1) : 0;
    return 0;
}
