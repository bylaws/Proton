...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets012_GetConnectionInfo( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *)params->linux_side;
    params->_ret = iface->GetConnectionInfo( params->hConn, (SteamNetConnectionInfo_t_153a *)params->pInfo );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets012_GetConnectionRealTimeStatus( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *)params->linux_side;
    params->_ret = iface->GetConnectionRealTimeStatus( params->hConn, (SteamNetConnectionRealTimeStatus_t *)params->pStatus, params->nLanes, (SteamNetConnectionRealTimeLaneStatus_t *)params->pLanes );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets012_ConfigureConnectionLanes( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *)params->linux_side;
    params->_ret = iface->ConfigureConnectionLanes( params->hConn, params->nNumLanes, (const int32_t *)params->pLanePriorities, (const uint16_t *)params->pLaneWeights );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets012_ResetIdentity( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *)params->linux_side;
    iface->ResetIdentity( (const SteamNetworkingIdentity_144 *)params->pIdentity );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets012_GetFakeIP( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *)params->linux_side;
    iface->GetFakeIP( params->idxFirstPort, (SteamNetworkingFakeIPResult_t *)params->pInfo );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets012_CreateListenSocketP2PFakeIP( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *)params->linux_side;
    params->_ret = iface->CreateListenSocketP2PFakeIP( params->idxFakePort, params->nOptions, (const SteamNetworkingConfigValue_t *)params->pOptions );
    return 0;
}
...
NTSTATUS wow64_ISteamNetworkingSockets_SteamNetworkingSockets012_GetRemoteFakeIPForConnection( void *args )
{
    ...
    struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *iface = (struct u_ISteamNetworkingSockets_SteamNetworkingSockets012 *)params->linux_side;
    params->_ret = iface->GetRemoteFakeIPForConnection( params->hConn, (SteamNetworkingIPAddr *)params->pOutAddr );
    return 0;
}
