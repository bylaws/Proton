...
NTSTATUS wow64_ISteamGameServer_SteamGameServer004_SendUserConnectAndAuthenticate( void *args )
{
    ...
    struct u_ISteamGameServer_SteamGameServer004 *iface = (struct u_ISteamGameServer_SteamGameServer004 *)params->linux_side;
    iface->SendUserConnectAndAuthenticate( params->steamIDUser, params->unIPClient, (void *)params->pvAuthBlob, params->cubAuthBlobSize );
    return 0;
}
...
NTSTATUS wow64_ISteamGameServer_SteamGameServer004_BSetServerType( void *args )
{
    ...
    struct u_ISteamGameServer_SteamGameServer004 *iface = (struct u_ISteamGameServer_SteamGameServer004 *)params->linux_side;
    params->_ret = iface->BSetServerType( params->nGameAppId, params->unServerFlags, params->unGameIP, params->unGamePort, params->unSpectatorPort, params->usQueryPort, (const char *)params->pchGameDir, (const char *)params->pchVersion, params->bLANMode );
    return 0;
}
