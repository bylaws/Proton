...
NTSTATUS wow64_ISteamController_SteamController006_GetDigitalActionData( void *args )
{
    ...
    struct u_ISteamController_SteamController006 *iface = (struct u_ISteamController_SteamController006 *)params->linux_side;
    *(ControllerDigitalActionData_t *)params->_ret = iface->GetDigitalActionData( params->controllerHandle, params->digitalActionHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController006_GetAnalogActionData( void *args )
{
    ...
    struct u_ISteamController_SteamController006 *iface = (struct u_ISteamController_SteamController006 *)params->linux_side;
    *(ControllerAnalogActionData_t *)params->_ret = iface->GetAnalogActionData( params->controllerHandle, params->analogActionHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController006_GetMotionData( void *args )
{
    ...
    struct u_ISteamController_SteamController006 *iface = (struct u_ISteamController_SteamController006 *)params->linux_side;
    *(ControllerMotionData_t *)params->_ret = iface->GetMotionData( params->controllerHandle );
    return 0;
}
