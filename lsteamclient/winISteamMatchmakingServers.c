...
struct w_steam_iface *create_winISteamMatchmakingServers_SteamMatchMakingServers001(U_PTR(void *u_iface, u_iface))
{
...
struct w_steam_iface *create_winISteamMatchmakingServers_SteamMatchMakingServers002(U_PTR(void *u_iface, u_iface))
{
