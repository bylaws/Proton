...
NTSTATUS wow64_ISteamController_SteamController008_GetActiveActionSetLayers( void *args )
{
    ...
    struct u_ISteamController_SteamController008 *iface = (struct u_ISteamController_SteamController008 *)params->linux_side;
    params->_ret = iface->GetActiveActionSetLayers( params->controllerHandle, (uint64_t *)params->handlesOut );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController008_GetDigitalActionData( void *args )
{
    ...
    struct u_ISteamController_SteamController008 *iface = (struct u_ISteamController_SteamController008 *)params->linux_side;
    *(InputDigitalActionData_t *)params->_ret = iface->GetDigitalActionData( params->controllerHandle, params->digitalActionHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController008_GetDigitalActionOrigins( void *args )
{
    ...
    struct u_ISteamController_SteamController008 *iface = (struct u_ISteamController_SteamController008 *)params->linux_side;
    params->_ret = iface->GetDigitalActionOrigins( params->controllerHandle, params->actionSetHandle, params->digitalActionHandle, (uint32_t *)params->originsOut );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController008_GetAnalogActionData( void *args )
{
    ...
    struct u_ISteamController_SteamController008 *iface = (struct u_ISteamController_SteamController008 *)params->linux_side;
    *(InputAnalogActionData_t *)params->_ret = iface->GetAnalogActionData( params->controllerHandle, params->analogActionHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController008_GetAnalogActionOrigins( void *args )
{
    ...
    struct u_ISteamController_SteamController008 *iface = (struct u_ISteamController_SteamController008 *)params->linux_side;
    params->_ret = iface->GetAnalogActionOrigins( params->controllerHandle, params->actionSetHandle, params->analogActionHandle, (uint32_t *)params->originsOut );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController008_GetMotionData( void *args )
{
    ...
    struct u_ISteamController_SteamController008 *iface = (struct u_ISteamController_SteamController008 *)params->linux_side;
    *(InputMotionData_t *)params->_ret = iface->GetMotionData( params->controllerHandle );
    return 0;
}
...
NTSTATUS wow64_ISteamController_SteamController008_GetControllerBindingRevision( void *args )
{
    ...
    struct u_ISteamController_SteamController008 *iface = (struct u_ISteamController_SteamController008 *)params->linux_side;
    params->_ret = iface->GetControllerBindingRevision( params->controllerHandle, (int32_t *)params->pMajor, (int32_t *)params->pMinor );
    return 0;
}
